defmodule Jalka2026Web do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: Jalka2026Web

      import Phoenix.LiveView.Router
      import Plug.Conn
      import Jalka2026Web.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/jalka2026_web/templates",
        namespace: Jalka2026Web
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {Jalka2026Web.LayoutView, :live}
