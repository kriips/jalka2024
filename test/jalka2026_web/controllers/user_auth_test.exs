defmodule Jalka2026Web.UserAuthTest do
  ...
  @remember_me_cookie "_jalka2026_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, Jalka2026Web.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      Jalka2026Web.Endpoint.subscribe(live_socket_id)
